...
it('renders languages from database and sets default session', function (): void {
    ...
    $component = Livewire::test('cms::language-switcher');
...
it('does not render switcher if only one language exists', function (): void {
    ...
    // A single language renders no switch links.
    $component = Livewire::test('cms::language-switcher');
    expect($component->get('languages'))->toHaveCount(1);
    $component->assertDontSee('setLanguage');
});
